...
namespace CasamentoBEC.CustomControls
{
    public class ViewTappedButtonBehavior : Behavior<Xamarin.Forms.View>
    {
        ...
        public Xamarin.Forms.View AssociatedObject { get; private set; }
